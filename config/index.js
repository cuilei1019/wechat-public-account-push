export const config = {
  ...
  USERS: [
    {
      ...
      id: "oh-dB6ZB9K9Rqi79IRzAvP1Vs360",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "G-9fuKsChtwKiqCtexkShPQNSa9uOF7cMORjBAko-Bs",
      // 所在省份
      province: "北京",
      // 所在城市
      city: "北京",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "美丽可爱亲亲老婆", "year": "1998", "date": "12-02"}
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2020-05-15"}
        // 结婚纪念日
  ...
  CALLBACK_TEMPLATE_ID: "BazPi7yJNI1bHhcb4X1HpisPelRqGfdpkvdWCQj_6G0",
